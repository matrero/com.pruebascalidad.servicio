...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#generalistas']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#generalistas']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-767d78b"));
				...
				assertEquals(" Pruebas generalistas",element3.getText());
			}	
		}
		catch(Exception e ){
