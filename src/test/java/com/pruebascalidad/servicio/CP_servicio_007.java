...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#business']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#business']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-9915a9c"));
				...
				assertEquals("Pruebas para Business Intelligence ",element3.getText());
			}	
		}
		catch(Exception e ){
