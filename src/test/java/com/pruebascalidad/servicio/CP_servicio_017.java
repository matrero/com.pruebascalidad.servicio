...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#Nomina']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#Nomina']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-5fc0d1c"));
				...
				assertEquals(" Pruebas de Nómina",element3.getText());
