...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#ambientes']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#ambientes']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-a5ca1b0"));
				...
				assertEquals("Administración de Ambientes de Pruebas",element3.getText());
			}	
		}
		catch(Exception e ){
