...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#performance']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#performance']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-7b0f291"));
				...
				assertEquals("  Pruebas de Desempeño",element3.getText());
			}	
		}
		catch(Exception e ){
