...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#usabilidad']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#usabilidad']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-23ef787"));
				...
				assertEquals(" Pruebas de Usabilidad",element3.getText());
			}	
		}
		catch(Exception e ){
