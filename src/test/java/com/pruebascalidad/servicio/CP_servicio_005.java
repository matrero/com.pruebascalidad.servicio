...
public class CP_servicio_005 {
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#digital']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#digital']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-194dff8"));
				...
				assertEquals("Digital Performance Management",element3.getText());
			}	
		}
		catch(Exception e ){
