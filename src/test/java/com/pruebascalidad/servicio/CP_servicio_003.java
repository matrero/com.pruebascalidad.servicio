...
public class CP_servicio_003 {
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#hacemos']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#hacemos']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-cb4d368"));
				...
				assertEquals("Cómo lo hacemos",element3.getText());
			}	
		}
		catch(Exception e ){
