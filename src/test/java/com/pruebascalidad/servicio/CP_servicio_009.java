...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#contables']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#contables']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-f7f12b2"));
				...
				assertEquals(" Pruebas contables y financieras ",element3.getText());
			}	
		}
		catch(Exception e ){
