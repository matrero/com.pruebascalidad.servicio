...
private WebDriver driver;
	...
	public void testIngresoServicioTitulo() throws InterruptedException {
		...
		String searchBox = driver.findElement(By.xpath("//a[@href='#cursos']")).getAttribute("href");
		driver.get(searchBox);
		try {
			if(driver.findElement(By.xpath("//a[@href='#cursos']")).isDisplayed()) {
				WebElement element = driver.findElement(By.className("elementor-element-1ce4591"));
				...
				assertEquals(" Cursos y Certificaciones",element3.getText());
